    ...
    <div class="container">
      <div class="row my-3">
        <div class="col d-flex justify-content-between">
          ...
          <div>
            <button @click="newProduct" class="btn btn-info">Nouveau produit fdd dfgdf</button>
          </div>
        </div>
        <h2>Category:</h2>
          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="product in products" :key="product.id">
                ...
                <td v-if="product.type_immo == 2"><img v-if="product.hasImg" :src="getImageUrl(product)"
                ...
                <td v-if="product.type_immo == 2"><a :href="`/products/edit/${product.id}`"
