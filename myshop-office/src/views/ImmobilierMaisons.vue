          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="product in products" :key="product.id">
                ...
                <td v-if="product.type_immo == 1"><img v-if="product.hasImg" :src="getImageUrl(product)"
                ...
                <td v-if="product.type_immo == 1"><a :href="`/products/edit/${product.id}`"
